        ...
        <Stack mt={2} sx={{ width: "80%", textAlign: "left" }} spacing={2}>
          ...
          <Alert variant="outlined" severity="error">
            ...
            ** You must earn a minimum “C” or higher grade in CSC courses which
            ...
            If your major catalog year is 2018 - 2019, 2019 - 2020 one of your
            CSC electives must have a database component: CSC 226, 315, or 424
            fit this criteria. CSC 315 is considered a 400-elective per dept.
            chairperson.
          </Alert>
        </Stack>
        <Legend />
